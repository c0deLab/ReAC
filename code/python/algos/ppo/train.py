...
while True:
    ...
    action = np.random.uniform(-1, 1, (n_agents, spec.action_size))
    # TODO: why? already 2D-ed, now action has two dimension, no need to flat 3-dim to 2-dim
    # TODO: this is turning action to 1D?
